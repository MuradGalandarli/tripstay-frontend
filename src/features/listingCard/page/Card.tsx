...
import { useGetPropertiesByCitiesQuery, type PropertyDto } from "../api/cardApi";
...
const filteredProperties: PropertyDto[] = searchText.trim()
    ? getAllProperty?.data?.filter((item) =>
            ...
            <div className="w-auto h-auto flex flex-col gap-4 justify-center">
                ...
                <div className="h-[50px] flex items-center gap-2">
                    <h1 className="font-[500] text-[20px]">
                        <p>{translation?.data?.data?.["Search.results"]}</p>
                    </h1>
                        ...
                        filteredProperties.map((item) => (
                            ...
                            >
                                <img
                                    ...
                                    alt={item.title}
                                    onClick={() =>
                                        navigation(`/detailProperty/${item.id}`)
                                    }
                                />
                         ...
                         <p>{translation?.data?.data?.["Search.noResults"]}</p>
                    )}
                ...
                {citiesData?.data?.map((city) => (
                    ...
                    >
                        ...
                        <div className="h-[50px] flex items-center gap-2">
                            <h1 className="font-[500] text-[20px]">
                                {city.cityName}{" "}
                                {translation?.data?.data?.["propertyNearbyListings"]}
                            </h1>
